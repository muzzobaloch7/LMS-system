...
<a href="{{ route('admin-panel.index') }}" class="btn btn-warning" style="border-radius: 20px; padding: 10px 20px; font-weight: bold; transition: background-color 0.3s;"><i class="fas fa-arrow-left"></i> Back</a>
</div>
@endsection
