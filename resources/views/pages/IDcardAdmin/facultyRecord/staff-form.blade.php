...
<head>
  ...
  <title>Staff ID Card Form</title>
  <style>
    .photo-preview {
      display: none;
      margin-top: 10px;
...
<body>
  <section class="header-section text-center mb-4">
    ...
    <div class="title-div">
      ...
      <h3>STAFF Service CARD FORM</h3>
    </div>
  </section>
    
 
  <section class="form-section container photo-upload-container mb-4 ">
    <form action="{{route('facultyrecords.store')}}" enctype="multipart/form-data" method="post">
      @csrf
      @if(session('success'))
    ...
    <div class="alert alert-{{ session('alert.type') }} alert-dismissible fade show" role="alert">
      ...
      <div class="row mb-3 ">
        ...
        <div class="col-md-6">
          ...
          <input type="text" id="name" name="staff_name" class="form-control" placeholder="Enter Your Name" value="{{Auth::user()->name}}" required>
        </div>
      </div>
      <div class="row mb-3">
        <div class="col-md-6">
      ...
      <div class="row mb-3">
        <div class="col-md-6">
          <label for="staff_id" class="form-label">Enrollment No:</label>
          <input type="text" id="staff_id" name="staff_id_no" class="form-control" placeholder="Enter Your Roll Number">
        </div>
        <div class="col-md-6">
          <label for="email" class="form-label">E-mail:</label>
          <input type="email" id="email" name="staff_email" class="form-control" placeholder="Enter Your Email e.g example@gmail.com" value="{{Auth::user()->email}}" required>
        </div>
      </div>
      <div class="row mb-3">
        <div class="col-md-6">
          <label for="dob" class="form-label">Date of Birth:</label>
          <input type="date" id="dob" name="staff_dob" class="form-control" required>
        </div>
        <div class="col-md-6">
          <label for="blood_group" class="form-label">Blood Group:</label>
          <input type="text" id="blood_group" name="staff_bg" class="form-control" placeholder="Enter Your Blood Group" required>
        </div>
      </div>
      <div class="row mb-3">
        <div class="col-md-6">
          <label for="contact_no" class="form-label">Contact No:</label>
          <input type="tel" id="contact_no" name="staff_contact_no" class="form-control" placeholder="Enter Your Contact Number" required>
        </div>
        <div class="col-md-6">
          <label for="emergency_contact_no" class="form-label">Emergency Contact No:</label>
          <input type="tel" id="emergency_contact_no" name="staff_emergency_contact_no" class="form-control" placeholder="Enter Your Emergency Number" required>
        </div>
      </div>
      <div class="row mb-3">
        <div class="col-md-6">
          <label for="address" class="form-label">Address:</label>
          <input type="text" id="address" name="staff_address" class="form-control" placeholder="Enter Your Complete Address" required>
        </div>
        <div class="col-md-6">
          <label for="nic_no" class="form-label">National Identity Card No:</label>
          <input type="number" id="nic_no" name="staff_nic_no" class="form-control" placeholder="Enter your NIC Number" required>
        </div>
      </div>
