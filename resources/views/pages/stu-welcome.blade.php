                    ...
                    @endif                    
                        <div class="d-flex justify-content-center align-items-center" style="height: 60vh;">
                            <div class="button-container d-flex justify-content-center flex-wrap" >
                                ...
                                <a href="{{ route('studentrecords.create') }}" class="btn btn-primary mb-2" style="border-radius: 20px; padding: 10px 20px; font-weight: bold; transition: background-color 0.3s;">
                                    <i class="fas fa-id-card"></i> Request for ID Card
                                </a>
