        ...
        <div class="row shadow">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                <section class="form-section container my-5">
                    ...
                    <div class="d-flex justify-content-center align-items-center" >
                        ...
                        <!-- {{--<div class="dropdown mt-2 mx-3">
                                    <button class="btn btn-primary dropdown-toggle" type="button" id="itServicesDropdown" data-bs-toggle="dropdown" aria-expanded="false" style="border-radius: 20px; padding: 10px 20px; font-weight: bold; transition: background-color 0.3s;">
                                        <i class="fas fa-user-cog"></i> IT Services
                                    </button>
                            ...
                            <!-- <a href="{{ route('logout') }}" class="btn btn-danger mb-2" style="border-radius: 20px; padding: 10px 20px; font-weight: bold; transition: background-color 0.3s;">
                                <i class="fas fa-sign-out-alt"></i> Logout
                            </a> -->
                        </div>
                    </div>
                ...
                <section class="form-section container mt-4">
                    <h2 class="text-center mb-4">Faculty IT Credentials</h2>
                        ...
                        <table class="table table-striped table-hover table-bordered">
                            <thead class="thead-dark">
                                <tr>
                                    ...
                                    <th scope="col">MicoSoft 360 Username</th>
                                    <th scope="col">MicoSoft 360 Password</th>
                                    <th scope="col">Turnitin Username</th>
                                    <th scope="col">Turnitin Password</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                @foreach($credentials as $credential)
                                    @if($credential->user_id == Auth::user()->id)
                                        <tr>
                                              ...
                                              <td>{{ $credential->micro_username }}</td>
                                              <td>{{ $credential->micro_password }}</td>
                                              <td>{{ $credential->turnit_username }}</td>
                                              <td>{{ $credential->turnit_password }}</td>
                                        </tr>
                                    @endif
                                @endforeach
                            </tbody>
