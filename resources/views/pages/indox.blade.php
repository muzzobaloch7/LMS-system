...
<head>
  ...
  <title>Student Portal - University of Gwadar</title>
...
<body>
    <header class="header d-flex flex-column p-4 shadow" style="background-color: #0b2f72; color: white;">
        ...
        <div style="border-radius: 50%; height: 80px; width: 80px; overflow: hidden; background-color:white; margin-left: -20px; ">
                <img class="" src="{{ asset('images/ug-logo.png') }}" alt="University Logo" style="object-fit:cover; height: 100%; width: 100%; margin-left:-5px;">
            </div>
            <div>
                ...
                <div class="sidebar-sticky">
                    <ul class="nav flex-column">
                        <li class="nav-item container-fluid">
                            <a class="nav-link active shadow-lg rounded" href="{{ route('studentrecords.create') }}" style="color: white; padding: 10px; transition: background-color 0.3s; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.2); margin: 5px 0;" onmouseover="this.style.backgroundColor='#007BFF'" onmouseout="this.style.backgroundColor='';">
                        ...
                        <li class="nav-item container-fluid">
                            <a class="nav-link active shadow-lg rounded" href="#" style="color: white; padding: 10px; transition: background-color 0.3s; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.2); margin: 5px 0;" onmouseover="this.style.backgroundColor='#007BFF'" onmouseout="this.style.backgroundColor='';">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                <section class="form-section container my-5">
                    ...
                    @endif                    
                        ...
                        <div class="table-responsive">
                          <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                              ...
                              @if($message->reciever_id==Auth::user()->id || $message->sender_name == "Result Admin")
                              <tr>
                        ...
                        <a href="{{ route('student') }}" class="btn btn-warning" style="border-radius: 20px; padding: 10px 20px; font-weight: bold; transition: background-color 0.3s;"><i class="fas fa-arrow-left"></i> Back</a>
                    </div>
                </section>
            </main>
