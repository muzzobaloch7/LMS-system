...
class IndoxController extends Controller
{
    ...
    public function facidstore(Request $request)
    {
        //
        Indox::create([
            'reciever_id' => $request->reciever_id,
        ...
        return redirect()->route('facultyrecords.sendMessage',['id' => $request->reciever_id])->with('status','Message sent successfully');
    }
